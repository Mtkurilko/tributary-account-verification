...
Date: 6/4/2025
Description: This script runs the ingestion process that grabs data from the dataset.json file and prepares it for the comparison model.
It creates Subject instances and pairs them for further processing. It also handles multiprocessing for efficiency.
"""
